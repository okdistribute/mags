...
⍝ the sql statement.
 ...
 Do←{
     0≠⊃z←#.SQL.ConnectTo'MAGSDB':(1⊃z)⎕SIGNAL⊃z
...
⍝ given defaults and we don't care about those. However, if there is a need
⍝ they can be specified here.
 
 InsertSubmission←{
     cols←2⌽(⍴⍵)↑'owner' 'submittedfor' 'date' 'code' 'isappeal' 'report'
     tbl←'submissions(',(com sep cols),')'
     bvs dat←(⊂':<S:')(1↑2⌽⍵),¨MkBVS 1↓2⌽⍵
     Do INSERT INTO tbl VALUES bvs dat
 }
