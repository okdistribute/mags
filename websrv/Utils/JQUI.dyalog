...
⍝ --- Widget functions ---
    ...
    ∇ r←{req}Dialog pars;id;title;innerhtml;jqpars;flag;chain
    ⍝ req - HTTPRequest object
    ...
    ⍝ updates req.Response.head and returns html
      ...
      :If 9=⎕NC'req' ⋄ req.Use'JQueryUI' ⋄ :EndIf
      r←''
      :If flag←~0∊⍴innerhtml ⋄ r←('title'title'id'id)#.HTML.div innerhtml ⋄ :EndIf
      r,←flag #.JQ.JQueryfn'dialog'id jqpars chain
    ∇
