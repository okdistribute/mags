:Namespace HTMLInput
    ...
    ∇ r←{name}Table pars;x;data;atts;tdc;tda;thc;tha;hdrrows;z;mask;cellids;n
    ⍝ pars: data table_atts cell_attribs header_attribs #header_rows cell-ids?
      :If 0=⎕NC'name' ⋄ name←'' ⋄ :EndIf
      :If 2=⍴⍴pars ⋄ pars←,⊂pars ⋄ :EndIf ⍝ Matrix of data only
      pars←pars,(⍴,pars)↓(1 1⍴⊂'data')'' '' '' 0 0
      data atts tda tha hdrrows cellids←pars
      hdrrows←⍬⍴hdrrows
